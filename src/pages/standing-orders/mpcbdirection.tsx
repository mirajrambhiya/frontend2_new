...
// Sample MPCB directions data - can be dynamically populated
const directionsData = [
    { id: 1, title: "MPCB Direction regarding Industrial Pollution Control 2024", date: "15 Jan, 2024" },
    { id: 2, title: "Direction on Consent to Operate Guidelines", date: "10 Feb, 2024" },
    { id: 3, title: "Updated Guidelines for Effluent Discharge Standards", date: "5 Mar, 2024" },
    { id: 4, title: "Direction on Air Emission Monitoring Compliance", date: "20 Mar, 2024" },
    { id: 5, title: "MPCB Direction regarding Hazardous Waste Management", date: "1 Apr, 2024" },
    { id: 6, title: "Guidelines for Common Effluent Treatment Plants", date: "15 Apr, 2024" },
    { id: 7, title: "Direction on Noise Pollution Standards", date: "1 May, 2024" },
    { id: 8, title: "Updated Online Consent Management System Guidelines", date: "20 May, 2024" },
    { id: 9, title: "Direction on Auto Renewal of Consents", date: "1 Jun, 2024" },
    { id: 10, title: "Guidelines for Self-Monitoring by Industries", date: "15 Jun, 2024" },
    { id: 11, title: "MPCB Direction regarding Solid Waste Processing", date: "1 Jul, 2024" },
    { id: 12, title: "Updated Guidelines for Biomedical Waste Treatment", date: "15 Jul, 2024" },
];

const DOCUMENTS_PER_PAGE = 6;

const MPCBDirections = () => {
