...
// Sample MOEF directions data - can be dynamically populated
const directionsData = [
    { id: 1, title: "MOEF Direction regarding Environmental Impact Assessment 2024", date: "15 Jan, 2024" },
    { id: 2, title: "Direction on Forest Conservation Guidelines", date: "10 Feb, 2024" },
    { id: 3, title: "Updated Guidelines for Wildlife Protection", date: "5 Mar, 2024" },
    { id: 4, title: "Direction on Coastal Regulation Zone Compliance", date: "20 Mar, 2024" },
    { id: 5, title: "MOEF Direction regarding Climate Change Mitigation", date: "1 Apr, 2024" },
    { id: 6, title: "Guidelines for Eco-Sensitive Zone Management", date: "15 Apr, 2024" },
    { id: 7, title: "Direction on Biodiversity Conservation Measures", date: "1 May, 2024" },
    { id: 8, title: "Updated Environmental Clearance Guidelines", date: "20 May, 2024" },
    { id: 9, title: "Direction on Green Belt Development", date: "1 Jun, 2024" },
    { id: 10, title: "Guidelines for Wetland Conservation", date: "15 Jun, 2024" },
    { id: 11, title: "MOEF Direction regarding Air Quality Management", date: "1 Jul, 2024" },
    { id: 12, title: "Updated Guidelines for River Conservation", date: "15 Jul, 2024" },
];

const DOCUMENTS_PER_PAGE = 6;

const MOEFDirections = () => {
