...
// Sample circulars data - can be dynamically populated
const circularsData = [
    { id: 1, title: "Circular regarding Environmental Compliance Guidelines 2024", department: "Environment Department", date: "15 Jan, 2024" },
    { id: 2, title: "Circular on Waste Management Procedures", department: "Waste Management", date: "10 Feb, 2024" },
    { id: 3, title: "Updated Guidelines for Industrial Emissions", department: "Technical Department", date: "5 Mar, 2024" },
    { id: 4, title: "Circular on Water Quality Standards", department: "Water Resources", date: "20 Mar, 2024" },
    { id: 5, title: "Circular regarding Air Quality Monitoring", department: "Air Quality Division", date: "1 Apr, 2024" },
    { id: 6, title: "Guidelines for Hazardous Waste Disposal", department: "Waste Management", date: "15 Apr, 2024" },
    { id: 7, title: "Circular on Noise Pollution Control Measures", department: "Environment Department", date: "1 May, 2024" },
    { id: 8, title: "Updated E-Waste Management Guidelines", department: "E-Waste Division", date: "20 May, 2024" },
    { id: 9, title: "Circular on Plastic Waste Management Rules", department: "Waste Management", date: "1 Jun, 2024" },
    { id: 10, title: "Guidelines for Bio-Medical Waste Handling", department: "Health Department", date: "15 Jun, 2024" },
    { id: 11, title: "Circular regarding Construction Waste Disposal", department: "Construction Division", date: "1 Jul, 2024" },
    { id: 12, title: "Updated Guidelines for Effluent Treatment", department: "Water Resources", date: "15 Jul, 2024" },
    { id: 13, title: "Circular on Solid Waste Segregation", department: "Waste Management", date: "1 Aug, 2024" },
    { id: 14, title: "Guidelines for Battery Waste Collection", department: "E-Waste Division", date: "15 Aug, 2024" },
    { id: 15, title: "Circular on Green Building Norms", department: "Environment Department", date: "1 Sep, 2024" },
    { id: 16, title: "Updated Air Pollution Control Guidelines", department: "Air Quality Division", date: "15 Sep, 2024" },
];
...
const Circulars = () => {
    ...
    const filteredDocuments = appliedSearch
        ? circularsData.filter(doc =>
            doc.title.toLowerCase().includes(appliedSearch.toLowerCase()) ||
            doc.department.toLowerCase().includes(appliedSearch.toLowerCase())
        )
        : circularsData;
            ...
            <section className="w-full flex justify-center bg-white py-12">
                <div className="w-full max-w-[1282px] px-4">
                    ...
                    <div className="mb-6 text-[14px] text-gray-500">
                        Showing {startIndex + 1}-{Math.min(startIndex + DOCUMENTS_PER_PAGE, filteredDocuments.length)} of {filteredDocuments.length} document{filteredDocuments.length !== 1 ? 's' : ''}
                    ...
                    {filteredDocuments.length === 0 && appliedSearch && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <p className="text-[14px] text-gray-500 max-w-[400px]">
                                ...
                                Try a different search term or clear the search to view all documents.
                            </p>
                            <button
                                onClick={handleClearSearch}
