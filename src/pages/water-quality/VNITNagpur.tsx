...
// Reusable Paginated Section Component (Copied from AirQuality.tsx)
...
function VNITNagpur() {
    ...
    const documents = [
        { id: 'vnit1', title: "Reconnaissance Survey and Network Design", pdfUrl: "#" },
        { id: 'vnit2', title: "Collection and Preservation of Samples and Field Analysis", pdfUrl: "#" },
        { id: 'vnit3', title: "Water Quality Analysis Laboratory Methods / LSD-NEERI- Water Quality Analysis", pdfUrl: "#" },
        { id: 'vnit4', title: "VNIT PKL-Data Management", pdfUrl: "#" },
        { id: 'vnit5', title: "Quality Control for Sampling and Chemical Analysis", pdfUrl: "#" },
        { id: 'vnit6', title: "Water Quality Monitoring & Analysis (NWMP/SWMP) – An Overview", pdfUrl: "#" },
        { id: 'vnit7', title: "QAQC in Water Quality Monitoring & Analysis", pdfUrl: "#" }
    ];
