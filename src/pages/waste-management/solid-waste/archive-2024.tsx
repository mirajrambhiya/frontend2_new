...
const sidebarItems = [
    { id: 'item1', title: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२४" },
    { id: 'item2', title: "महाराष्ट्र प्रदूषण नियंत्रण मंडळ व महाराष्ट्र कला संस्कृती मंच यांच्या संयुक्त विद्यमाने कार्तिकीची वारी, पंढरीच्या दारी" },
    { id: 'item3', title: "Eco-Friendly Dahihandi - 2024" }
];
...
const Archive2024 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[], document?: any }> = {
        "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२४": {
            ...
            videos: [
                { id: 1, title: "Ganesh Competition 2024 Highlights", thumbnail: "https://placehold.co/600x400?text=Ganesh+Competition+2024+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        },
        "महाराष्ट्र प्रदूषण नियंत्रण मंडळ व महाराष्ट्र कला संस्कृती मंच यांच्या संयुक्त विद्यमाने कार्तिकीची वारी, पंढरीच्या दारी": {
            description: "पर्यावरण शिक्षणाचे धडे देई घरोघरी या पर्यावरण जनजागृती अभियानाचा समारोप तत्कालीन मा. उपमुख्यमंत्री श्री. देवेंद्रजी फडणवीस यांच्या शुभहस्ते पंढरपूर येथे संपन्न झाला. विठू माऊलीच्या चरणी पर्यावरणाच्या रक्षणाची शपथ घेत वारकरी संप्रदायाने या उपक्रमात मोठ्या संख्येने सहभाग नोंदवला. जल, वायू आणि ध्वनी प्रदूषण टाळण्याबाबत या अभियानातून जनजागृती करण्यात आली.",
            photos: Array.from({ length: 6 }, (_, i) => ({
                id: i + 1,
                title: `Kartiki Wari Event Photo ${i + 1}`,
                date: "2024",
                images: [`https://placehold.co/800x600?text=Kartiki+Wari+Event+Photo+${i + 1}`]
            })),
            videos: []
        },
        "Eco-Friendly Dahihandi - 2024": {
            description: "Ideal sanskrutik Manch and M.P.C.B. jointly organized Eco-Friendly Dahihandi at Dadar. The aim of this Public Awareness activity to reduce noise during the festivals. In this event, we had performend various activities including street play, women pyramids etc.",
            photos: Array.from({ length: 5 }, (_, i) => ({
                id: i + 1,
                title: `Dahihandi 2024 Photo ${i + 1}`,
                date: "2024",
                images: [`https://placehold.co/800x600?text=Dahihandi+2024+Photo+${i + 1}`]
            })),
            videos: []
        }
    };
