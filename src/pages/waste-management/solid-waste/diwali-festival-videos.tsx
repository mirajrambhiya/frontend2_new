...
const diwaliVideoCategories = [
    "Diwali Wishes",
    "Diwali Tv News",
    "Diwali Shapath",
    "Diwali Ads and Promo"
];

const DiwaliFestivalVideos = () => {
    const [selectedCategory, setSelectedCategory] = useState(diwaliVideoCategories[0]);
    const [isDropdownOpen, setIsDropdownOpen] = useState(false);
    const [selectedVideo, setSelectedVideo] = useState<any>(null);

    const videoData: Record<string, any[]> = {
        "Diwali Wishes": [
            { id: 1, title: "Diwali Wishes - Minister 1", thumbnail: "https://placehold.co/600x400?text=Diwali+Wishes+1", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
            { id: 2, title: "Diwali Wishes - Minister 2", thumbnail: "https://placehold.co/600x400?text=Diwali+Wishes+2", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
        ],
        "Diwali Tv News": [
            { id: 3, title: "Diwali Awareness on News", thumbnail: "https://placehold.co/600x400?text=Diwali+News", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
        ],
        "Diwali Shapath": [
            { id: 4, title: "Diwali Pollution-Free Pledge", thumbnail: "https://placehold.co/600x400?text=Diwali+Shapath", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
        ],
        "Diwali Ads and Promo": [
            { id: 5, title: "Eco-Friendly Diwali Promo", thumbnail: "https://placehold.co/600x400?text=Diwali+Ads", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
        ]
    };
...
export default DiwaliFestivalVideos;
