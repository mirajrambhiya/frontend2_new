...
const sidebarItems = [
    { id: 'item1', title: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२०" },
    { id: 'item2', title: "Eco-Friendly Dahihandi – 2020" }
];
...
const Archive2020 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[], document?: any }> = {
        "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२०": {
            description: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२० याचा पारितोषिक वितरण समारंभ मुंबई येथे आयोजित करण्यात आला होता. या उपक्रमाद्वारे नागरिकांना पर्यावरणपूरक गणेशोत्सव साजरा करण्यासाठी प्रोत्साहित करण्यात आले. शाडूच्या मातीचे गणपती आणि नैसर्गिक रंगांचा वापर यावर या स्पर्धेत भर देण्यात आला होता. कोरोना काळातही भक्तांनी या स्पर्धेला उदंड प्रतिसाद दिला, ज्यातून पर्यावरणाप्रती असलेली त्यांची जागरूकता दिसून आली.",
            ...
            videos: [
                { id: 1, title: "Ganesh Competition 2020 Highlights", thumbnail: "https://placehold.co/600x400?text=Ganesh+Competition+2020+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        },
        "Eco-Friendly Dahihandi – 2020": {
            ...
            photos: Array.from({ length: 5 }, (_, i) => ({
                id: i + 1,
                title: `Dahihandi 2020 Photo ${i + 1}`,
                date: "2020",
                images: [`https://placehold.co/800x600?text=Dahihandi+2020+Photo+${i + 1}`]
            })),
            videos: []
        }
    };
