...
const sidebarItems = [
    { id: 'item1', title: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२३" },
    { id: 'item2', title: "Eco-Friendly Dahihandi – 2023" }
];
...
const Archive2023 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[], document?: any }> = {
        "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२३": {
            ...
            videos: [
                { id: 1, title: "Ganesh Competition 2023 Highlights", thumbnail: "https://placehold.co/600x400?text=Ganesh+Competition+2023+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        },
        "Eco-Friendly Dahihandi – 2023": {
            ...
            photos: Array.from({ length: 5 }, (_, i) => ({
                id: i + 1,
                title: `Dahihandi 2023 Photo ${i + 1}`,
                date: "2023",
                images: [`https://placehold.co/800x600?text=Dahihandi+2023+Photo+${i + 1}`]
            })),
            videos: []
        }
    };
