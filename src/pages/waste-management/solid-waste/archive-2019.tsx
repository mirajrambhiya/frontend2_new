...
const sidebarItems = [
    { id: 'item1', title: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०१९" },
    { id: 'item2', title: "Eco-Friendly Dahihandi - 2019" }
];
...
const Archive2019 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[], document?: any }> = {
        "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०१९": {
            ...
            videos: [
                { id: 1, title: "Ganesh Competition 2019 Highlights", thumbnail: "https://placehold.co/600x400?text=Ganesh+Competition+2019+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        },
        "Eco-Friendly Dahihandi - 2019": {
            description: "Ideal Sanskritic Manch and M.P.C.B. jointly organized Eco-Friendly Dahihandi at Dadar. The aim of this Public Awareness activity to reduce noise during the festivals. In this event, we had performed various activities including street play, women pyramid etc.",
            photos: Array.from({ length: 5 }, (_, i) => ({
                id: i + 1,
                title: `Dahihandi 2019 Photo ${i + 1}`,
                date: "2019",
                images: [`https://placehold.co/800x600?text=Dahihandi+2019+Photo+${i + 1}`]
            })),
            videos: []
        }
    };
