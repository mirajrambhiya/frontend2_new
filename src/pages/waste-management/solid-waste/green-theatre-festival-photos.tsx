...
const greenTheatrePhotosCategories = [
    "Green Theatre Pune 2017",
    "Green Theatre Nagpur 2017",
    "Green Theatre Kolhapur 2017",
    "Green Theatre Festival Ratnagiri 17-18",
    "Green Theatre Festival Pune Dec 2019",
    "Green Theatre Festival Nashik 17-18",
    "Green Theatre Festival Mumbai 2018",
    "Green Theatre Festival Elims",
    "Green Theatre Festival 2018 Nagpur",
    "Green Theatre Aurangabad 2017"
];

const GreenTheatreFestivalPhotos = () => {
    const [selectedCategory, setSelectedCategory] = useState(greenTheatrePhotosCategories[0]);
    ...
    greenTheatrePhotosCategories.forEach(cat => {
                    ...
                    <div className="relative w-full h-[200px] md:h-[250px] lg:h-[280px] rounded-t-[30px] md:rounded-t-[40px] lg:rounded-t-[48px] overflow-hidden">
                        ...
                        <div className="relative z-30 flex flex-col items-center justify-center h-full text-center px-4 md:px-6 mt-[-20px] md:mt-[-30px]">
                            <h1 className="text-[28px] md:text-[36px] lg:text-[40px] font-bold text-[#000000] tracking-tight leading-tight md:leading-none mb-4 md:mb-8">
                                Green Theatre Festival - Photo Gallery
                            </h1>
                        </div>
                    ...
                    <div className="w-full max-w-[500px]">
                        ...
                        {isDropdownOpen && (
                            <div className="absolute top-full left-0 w-full mt-2 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-y-auto max-h-[400px] animate-in fade-in slide-in-from-top-2 duration-200">
                                {greenTheatrePhotosCategories.map((cat) => (
                                    <button
                                        key={cat}
                                        onClick={() => {
...
export default GreenTheatreFestivalPhotos;
