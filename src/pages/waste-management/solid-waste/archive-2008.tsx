...
const sidebarItems = [
    { id: 'item1', title: "Jagar Paryavarnacha program is broadcasted on Asmita Radio Channel." }
];
...
const Archive2008 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[] }> = {
        "Jagar Paryavarnacha program is broadcasted on Asmita Radio Channel.": {
            description: "'Jagar Paryavarnacha' program on environment awareness launched from 5th June 2008 on All India Radio's (AIR) channel - Asmita. The program will be broadcasted every Thursday at 7:40 a.m. on Asmita Channel (Radio). The program consists of interviews of environmentalists, NGOs and technical experts in the field of environment. The programme is produced by MPCB and is conceptualised by Shri Sanjay Khandare (IAS), Member Secretary, MPCB. The program is designed with advise and guidance from Shri Shyamlal Goyal, Secretary, Environment Department and Chairman, MPCB.",
            photos: Array.from({ length: 4 }, (_, i) => ({
                id: i + 1,
                title: `Jagar Paryavarnacha Photo ${i + 1}`,
                date: "2008",
                images: [`https://placehold.co/800x600?text=Jagar+Paryavarnacha+Photo+${i + 1}`]
            })),
            videos: [
                { id: 1, title: "Jagar Paryavarnacha Highlights", thumbnail: "https://placehold.co/600x400?text=Jagar+Paryavarnacha+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        }
    };
