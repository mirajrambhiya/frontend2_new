...
const wariVideoCategories = [
    "Wari All Channels Video MPCB",
    "Wari 2018",
    "Wari 2016 Chief Minister Pooja Mann",
    "MPCB Special Ashadi Coverage"
];

const WariFestivalVideos = () => {
    const [selectedCategory, setSelectedCategory] = useState(wariVideoCategories[0]);
    const [isDropdownOpen, setIsDropdownOpen] = useState(false);
    const [selectedVideo, setSelectedVideo] = useState<any>(null);

    const videoData: Record<string, any[]> = {};
    wariVideoCategories.forEach(cat => {
        videoData[cat] = [
            { id: 1, title: `${cat} Highlights`, thumbnail: `https://placehold.co/600x400?text=${cat.replace(/ /g, '+')}+Highlights`, videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
            { id: 2, title: `${cat} Coverage Part 2`, thumbnail: `https://placehold.co/600x400?text=${cat.replace(/ /g, '+')}+Part+2`, videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" },
        ];
    });
...
export default WariFestivalVideos;
