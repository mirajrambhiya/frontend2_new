...
const ganeshPhotosCategories = [
    "Times Green Ganesha",
    "Murti Pradarshan",
    "MPCB GANPATI MANDAL VISIT",
    "MPCB ECO GANESH AWARD 2018",
    "MPCB Eco Friendly Pandals",
    "MPCB - Eco-Friendly Ganpati ABP MAZA",
    "Loksatta eco ganpati photo 2017",
    "Loksatta eco ganpati photo 2014",
    "Loksatta eco ganpati photo 2013",
    "Green Ganesha 2015",
    "Ganpati Sayadhri Guest House",
    "Eco ganpati 2015",
    "Eco ganpati 2014",
    "Eco Ganesha pics",
    "ECO GANESH AWARDS 2016",
    "Eco friendly ganpati competition 2009",
    "ECO BAPPA MPCB EVENT",
    "DNA ECO GANESHA 2011",
    "Big Green Ganesh 2016"
];

const GaneshFestivalPhotos = () => {
    const [selectedCategory, setSelectedCategory] = useState(ganeshPhotosCategories[0]);
    const [isDropdownOpen, setIsDropdownOpen] = useState(false);
    const [selectedAlbum, setSelectedAlbum] = useState<any>(null);
    const [currentImageIndex, setCurrentImageIndex] = useState(0);

    // Dummy data generation based on category
    const galleryData: Record<string, any[]> = {};
    ganeshPhotosCategories.forEach(cat => {
                    ...
                    <div className="w-full max-w-[400px]">
                        ...
                        {isDropdownOpen && (
                            <div className="absolute top-full left-0 w-full mt-2 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-y-auto max-h-[400px] animate-in fade-in slide-in-from-top-2 duration-200">
                                {ganeshPhotosCategories.map((cat) => (
                                    <button
                                        key={cat}
                                        onClick={() => {
...
export default GaneshFestivalPhotos;
