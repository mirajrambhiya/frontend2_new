...
const sidebarItems = [
    { id: 'item1', title: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२१" }
];
...
const Archive2021 = () => {
    ...
    const eventData: Record<string, { description?: string, photos: any[], videos: any[], document?: any }> = {
        "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२१": {
            description: "लोकसत्ता व म. प्र. नि. मंडळ यांच्या संयुक्त विद्यमाने पर्यावरण पूरक घरगुती गणेश उत्सव स्पर्धा २०२१ याचा पारितोषिक वितरण समारंभ मुंबई येथे आयोजित करण्यात आला होता. या उपक्रमाद्वारे नागरिकांना पर्यावरणपूरक गणेशोत्सव साजरा करण्यासाठी प्रोत्साहित करण्यात आले. शाडूच्या मातीचे गणपती आणि नैसर्गिक रंगांचा वापर यावर या स्पर्धेत भर देण्यात आला होता. पर्यावरणाप्रती लोकांची वाढती जागरूकता या उपक्रमामुळे दिसून आली.",
            ...
            videos: [
                { id: 1, title: "Ganesh Competition 2021 Highlights", thumbnail: "https://placehold.co/600x400?text=Ganesh+Competition+2021+Video", videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4" }
            ]
        }
    };
