...
interface NagpurBenchEnvironmentRulesData {
    caseNo: string;
    orderDate: string;
    particulars: string;
    link?: string;
...
const nagpurBenchEnvironmentRulesData: NagpurBenchEnvironmentRulesData[] = [
    {
    ...
    {
        caseNo: "W.P.No.1221/2009",
        orderDate: "19/11/2009",
        particulars: "Shri Nilesh Pandurang Kharbade V/s. The State of Maharashtra and Others",
        link: "#"
    }
];

const NagpurBenchEnvironmentRules = () => {
    return (
        <div className="min-h-screen bg-white">
            <PageBanner
                title="NAGPUR BENCH- ENVIRONMENT (P) RULES, 1986"
                ...
                <div className="border border-gray-200 rounded-[35px] overflow-hidden w-full shadow-sm">
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {nagpurBenchEnvironmentRulesData.map((row, idx) => (
...
export default NagpurBenchEnvironmentRules;
