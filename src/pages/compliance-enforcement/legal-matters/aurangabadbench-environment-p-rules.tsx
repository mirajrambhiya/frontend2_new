...
interface AurangabadEnvironmentPRulesData {
    caseNo: string;
    orderDate: string;
    particulars: string;
    link?: string;
...
const aurangabadEnvironmentPRulesData: AurangabadEnvironmentPRulesData[] = [
    {
        caseNo: "W.P.No.2911/2006",
        orderDate: "01/04/2011",
        particulars: "Mukram Jaan Gul Mohd. Khan Pathan (Tadvi)",
        link: "#"
    }
];

const AurangabadBenchEnvironmentPRules = () => {
    return (
        <div className="min-h-screen bg-white">
            <PageBanner
                title="AURANGABAD BENCH - ENVIRONMENT (P) RULES, 1986"
                subTitle="ARCHIVE"
                ...
                <div className="border border-gray-200 rounded-[35px] overflow-hidden w-full shadow-sm">
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {aurangabadEnvironmentPRulesData.map((row, idx) => (
...
export default AurangabadBenchEnvironmentPRules;
