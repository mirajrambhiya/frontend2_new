...
interface AurangabadNoisePollutionData {
    caseNo: string;
    orderDate: string;
    particulars: string;
    link?: string;
...
const aurangabadNoisePollutionData: AurangabadNoisePollutionData[] = [
    {
        caseNo: "W.P.no.4882/2013",
        orderDate: "19/12/2013",
        particulars: "Dr Nandkumar Ukadgaonkar V/s State of Maharashtra and Others",
        link: "#"
    },
    {
        caseNo: "PIL No 173/2010",
        orderDate: "16/08/2016",
...
const AurangabadBenchNoisePollution = () => {
    return (
                ...
                <div className="border border-gray-200 rounded-[35px] overflow-hidden w-full shadow-sm">
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {aurangabadNoisePollutionData.map((row, idx) => (
...
export default AurangabadBenchNoisePollution;
