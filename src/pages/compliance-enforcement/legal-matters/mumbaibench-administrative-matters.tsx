...
const adminMattersData: AdminMatterData[] = [
    {
        caseNo: "",
        orderDate: "13/01/2004",
        particulars: "Group Service Matters",
        link: "#"
    }
];

const MumbaiBenchAdministrativeMatters = () => {
    return (
        <div className="min-h-screen bg-white">
            <PageBanner
                title="MUMBAI BENCH- ADMINISTRATIVE MATTERS"
...
export default MumbaiBenchAdministrativeMatters;
