...
interface NagpurBenchAirActData {
    caseNo: string;
    orderDate: string;
    particulars: string;
    link?: string;
...
const nagpurBenchAirActData: NagpurBenchAirActData[] = [
    {
        caseNo: "W.P.No.1497/2012",
        orderDate: "24/04/2013",
        particulars: "Vidarbha Ind.Association and Others Vs State of Maharashtra and Others",
        link: "#"
    }
];

const NagpurBenchAirAct = () => {
    return (
        <div className="min-h-screen bg-white">
            <PageBanner
                title="NAGPUR BENCH- AIR( P & CP) ACT, 1974"
                ...
                <div className="border border-gray-200 rounded-[35px] overflow-hidden w-full shadow-sm">
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {nagpurBenchAirActData.map((row, idx) => (
...
export default NagpurBenchAirAct;
