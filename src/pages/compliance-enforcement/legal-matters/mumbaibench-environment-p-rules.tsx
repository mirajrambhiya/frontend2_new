...
interface EnvironmentPRulesData {
    caseNo: string;
    orderDate: string;
    particulars: string;
    link?: string;
...
const environmentPRulesData: EnvironmentPRulesData[] = [
    {
        caseNo: "PIL No.131/2012",
        orderDate: "07/02/2013",
        particulars: "Jalbiradari & Ors V/s. MumbaiMetropolitan Regional kDevelopment Authority & Ors.",
        link: "#"
    }
];

const MumbaiEnvironmentPRules = () => {
    return (
        <div className="min-h-screen bg-white">
            <PageBanner
                title="MUMBAI BENCH- ENVIRONMENT (PROTECTION)ACT, 1986" // Title closely matches the image header
                ...
                <div className="border border-gray-200 rounded-[35px] overflow-hidden w-full shadow-sm">
                    <table className="w-full border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {environmentPRulesData.map((row, idx) => (
...
export default MumbaiEnvironmentPRules;
